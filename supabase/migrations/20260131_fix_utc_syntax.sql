-- Fix UTC Syntax Error in Timezone Performance Migration
-- The previous migration used incorrect syntax for TIMESTAMP WITH TIME ZONE columns
-- Error: "invalid input syntax for type date: \"utc\""

-- Fix increment_received_newsletter function
...
BEGIN
    ...
    DO UPDATE SET 
        ...
        updated_at = now(); -- now() already returns timestamp with time zone
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;

-- Fix increment_source_count function  
...
-- Fix can_receive_newsletter function
...
-- Fix check_source_limit function
