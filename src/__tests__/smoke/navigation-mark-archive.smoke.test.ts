...
describe('Navigation Mark and Archive Smoke Tests', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(useSharedNewsletterActions).mockReturnValue({
      ...
      handleBulkToggleLike: vi.fn(),
      handleBulkDelete: vi.fn(),
      handleBulkToggleArchive: vi.fn(),
      handleBulkToggleInQueue: vi.fn(),
      handleBulkAction: vi.fn(),
      handleBulkAddTags: vi.fn(),
      handleBulkRemoveTags: vi.fn(),
      handleAddTag: vi.fn(),
      handleRemoveTag: vi.fn(),
      handleCreateTag: vi.fn(),
      handleUpdateTag: vi.fn(),
      handleDeleteTag: vi.fn(),
      handleCreateSource: vi.fn(),
      handleUpdateSource: vi.fn(),
      handleDeleteSource: vi.fn(),
      handleArchiveSource: vi.fn(),
      handleCreateSourceGroup: vi.fn(),
      handleUpdateSourceGroup: vi.fn(),
      handleDeleteSourceGroup: vi.fn(),
      handleAddSourceToGroup: vi.fn(),
      handleRemoveSourceFromGroup: vi.fn(),
      handleToggleSourceGroupArchive: vi.fn(),
      withOptions: vi.fn(),
    });
